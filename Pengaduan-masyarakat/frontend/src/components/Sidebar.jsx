...
const Sidebar = () => {
    ...
    const menuItems = [
        ...
        { label: "Mata Pelajaran", icon: <FaBook />, path: "mata-pelajaran" },
...
return (
    <div className="bg-indigo-700 text-white h-screen fixed w-60 p-5">
        ...
        <div className="flex flex-col items-center pt-2 gap-3">
            ...
            <button
                key={item.label}
                className="flex items-center w-full relative text-white font-bold py-2 px-4 rounded hover:bg-black transition duration-100 ease-in-out"
